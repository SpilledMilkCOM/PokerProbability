...
require("rxjs/add/operator/map"); // Define the "map" function from a node module.
...
var CardService = /** @class */ (function () {
    ...
    CardService.prototype.winPercent = function () {
    ...
    CardService = __decorate([
        core_1.Injectable() // similar to Angular 1's $inject
        ,
